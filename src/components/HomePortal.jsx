...
import { GitBranch, ArrowRight, FolderArchive, FileText } from 'lucide-react';
...
export default function HomePortal({ session, onNavigateToCases, onNavigateToIntelligence, onOpenRecentCase }) {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6 px-4 space-y-4 font-sans">
      {/* Primary Navigation Cards (No welcome banner) */}
      ...
      <div className="dossier-card p-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          ...
          className="px-3 py-1.5 bg-[#C68A46] hover:bg-[#D49855] text-[#12151B] rounded-[5px] text-xs font-semibold transition flex items-center gap-1.5"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center text-xs">
        <div className="dossier-card p-2.5">
